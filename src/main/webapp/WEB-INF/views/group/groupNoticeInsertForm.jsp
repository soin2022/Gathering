    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <h2 style="padding-top:5%">${group.group_name} 공지등록</h2>

                <!-- 모임생성폼 폼-->

                <form class="container row" id="formm" style="float: none; margin:100 auto;" action="/groupNoticeInsertAction" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-auto">
                                <select class="form-select" aria-label="Default select example" name="type" id="type"  onclick="onActive()">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-auto">
                                <textarea type="text" class="form-control" id="content" cols="70"
                                    rows="5" placeholder="상세소개를 작성해 주세요." name="content" style="resize:none;"></textarea>
                            </div>
                        </div>
                        ...
                        <!-- 생성 / 취소 -->
                            <div class="row">
                                <div class="col text-center">
                                    <input class="btn btn-primary" style="margin-right: 10px;" type="button"  onclick="groupNotice_save()" value="등록">
                                    <button class="btn btn-primary" type="button" onclick="location.href='/group/groupNoticeListView?group_seq=${group.group_seq}'">취소</button>
                                </div>
                            </div>
                        </div>
                </form>
