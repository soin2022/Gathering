...
<body id="page-top">
		...
		<%@ include file="/WEB-INF/views/navibar.jsp" %>
            ...
            <form id="createNewGroupForm" method="post" container row" style="float: none; margin:100 auto;">
                ...
                <div class="mb-3">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-auto">
                            <input type="text" class="form-control" id="group_name" name="group_name" maxlength="6" placeholder="모임명을 입력해 주세요.">
                            <input type="hidden" id="rename" name="rename">
                        </div>
                        <div class="col-auto">
                           <button type="button" class="btn btn-primary" onclick="groupNameCheck()">중복체크</button>
                        </div>
                    </div>
                    <!--간단소개-->
                    <div class="row mb-2">
                        ...
                        <div class="col-auto">
                            <input type="text" size="70" class="form-control" id="brief" name="brief" placeholder="간단소개를 작성해 주세요.">
                        </div>
                    </div>
                    <!--상세소개-->
                    <div class="row mb-2">
                        ...
                        <div class="col-auto">
                            <textarea type="text" class="form-control" id="detail" name="detail" cols="70" rows="5" placeholder="상세소개를 작성해 주세요." style="resize:none;"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="row mb-2">
                     ...
                     <div class="row mb-2">
                        ...
                        <div class="col-auto">
                            <select class="form-select" in="region" name="region">
                    ...
                    <div class="row">
                        <div class="col text-center">
                            <input class="btn btn-primary" style="margin-right: 10px;" type="button" value="생성" onclick="createGroup()">
