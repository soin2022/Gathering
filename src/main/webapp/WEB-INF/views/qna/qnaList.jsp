            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <h2 style="padding-top:5%">{Q&A게시판}</h2> 
                    ...
                    <div class="row mb-2 align-items-center">
                        ...
                        <div class="col">
                        <button type="button" class="btn btn-outline-primary" style="float:right; margin-right:10px">문의하기</button>
                        </div>    
                    </div>
                ...
                <form class="row mb-3 align-items-center justify-content-center">
