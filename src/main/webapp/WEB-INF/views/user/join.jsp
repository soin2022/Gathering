                ...
                <form action="joinForm" id="joinForm" method="post" class="container row" style="float: none; margin:100 auto;">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-auto">
                                <input type="text" class="form-control" id="user_id" name="user_id" placeholder="회원ID" autocomplete="off">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-auto">
                                <input type="text" class="form-control" id="name" name="name" placeholder="이름" autocomplete="off">
                            </div>
                        </div>
                        <!--닉네임-->
                        <div class="row mb-2">
                            ...
                            <div class="col-auto">
                                <input type="text" class="form-control" id="nickname" name="nickname" placeholder="닉네임" autocomplete="off">
                            </div>
                        </div>
                        <!--성별-->
                        <div class="row mb-2">
                            ...
                            <div class="col-auto">
                                <div class="row" style="padding-left:10px;">
                                    <div class="form-check col-auto py-2">
                                        <input class="form-check-input" type="radio" name="gender" id="gender" value="1" checked>남자
                                    </div>
                                    <div class="form-check col-auto py-2">
                                        <input class="form-check-input" type="radio" name="gender" id="gender" value="2">여자
                                    </div>
                                    <div class="form-check col-auto py-2">
                                        <input class="form-check-input" type="radio" name="gender" id="gender" value="0">선택안함
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-auto">
                                <input type="text" class="form-control" id="year" name="birthday" placeholder="년도" autocomplete="off">
                            </div>
                            <div class="col-auto">
                            ...
                            <div class="col-auto">
                                <input type="text" class="form-control" id="date" name="birthday" maxlength="2" placeholder="일" autocomplete="off">
                            </div>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-auto">
                                <input type="text" class="form-control" id="email1" placeholder="이메일" autocomplete="off">
                            </div>
                            @
                            <div class="col-auto">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="row">
                                <div class="col text-center">
                                    <input class="btn btn-primary" style="margin-right: 10px;" type="button" value="가입하기" onclick="go_save()">
                                    <button class="btn btn-primary" type="button" onclick="location.href='/main'">취소</button>
                                </div>
                            </div>
